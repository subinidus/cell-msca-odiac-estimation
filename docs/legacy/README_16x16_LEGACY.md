# Legacy 16×16 Poster-Stage README

> [!WARNING]
> This document records the earlier poster-stage 16×16 experiment only.
> Its numerical results have not been reproduced under the current single-cell Cell-MSCA protocol and must not be cited as current paper results.
> Hotspot, policy, causal, source-attribution, and “decisive spatial context” interpretations are not part of the current research claim.
> This file is retained solely as project history; see the repository-root README and RESEARCH_STATUS.md for the active project contract.
